    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content col-md-6">
                <h4 class="nk-block-title">Sub Category<a href="/subcategory/create" type="button" class="btn btn-primary pull-right" style="position:absolute;right:10px">Add Category</a></h4>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <form action="{{ route('subcategory.destroy',$data->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="/subcategory/{{$data->id}}/edit"><em class="icon ni ni-edit-fill edit-subcategory" style="color:rgb(238, 210, 85) !important;"></em></a>
                                    &nbsp;&nbsp;
