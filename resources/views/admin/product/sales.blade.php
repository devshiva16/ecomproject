            ...
            <div class="card-inner p-0">
                <div class="nk-tb-list">
                    <div class="nk-tb-item nk-tb-head">
                        ...
                        <div class="nk-tb-col tb-col-sm"><span>About ----</span></div>
                        <div class="nk-tb-col"><span>Contact No.</span></div>
                        <div class="nk-tb-col"><span>Email</span></div>
                        <div class="nk-tb-col"><span>Website</span></div>
                        <div class="nk-tb-col"><span>Contact No.2</span></div>
                        <div class="nk-tb-col"><span>Land Line No.</span></div>
                    ...
                    <div class="nk-tb-item">
                        ...
                        <div class="nk-tb-col">
                            <span class="tb-sub">email</span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">website</span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">contect no.2</span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">land line no.</span>
                        </div>
                        <div class="nk-tb-col">
