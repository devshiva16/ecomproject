...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Address</h3>
            ...
            <div class="card-inner p-0">
                <div class="nk-tb-list">
                    <div class="nk-tb-item nk-tb-head">
                        ...
                        <div class="nk-tb-col tb-col-sm"><span>Address Line 1</span></div>
                        <div class="nk-tb-col tb-col-sm"><span>Address Line 2</span></div>
                        <div class="nk-tb-col tb-col-sm"><span>City</span></div>
                        <div class="nk-tb-col tb-col-sm"><span>State</span></div>
                        <div class="nk-tb-col tb-col-sm"><span>Pincode</span></div>
                    ...
                    <div class="nk-tb-item">
                        ...
                        <div class="nk-tb-col tb-col-sm">
                            <span class="tb-product">
                                ...
                                <span class="tb-sub">address line 1</span>
                            </span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">address line 2</span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">city</span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">state</span>
                        </div>
                        <div class="nk-tb-col">
                            <span class="tb-sub">pincode</span>
                        </div>
