                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="father_name" value="" class="form-control" placeholder="Father Name">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="mother_name" value="" class="form-control" placeholder="Mother Name">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="parent_number" value="" class="form-control" placeholder="Parent Number">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="permanent_address" value="" class="form-control" placeholder="Permanent Address">
                                    </div>
                                </div>
                                <div class="form-group">
