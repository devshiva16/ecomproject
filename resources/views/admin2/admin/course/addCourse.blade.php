...
@section('BodyContent')
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="{{asset('/course')}}">Course</a></li><li class="active">Add Course</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
            ...
            <div class="widget">
                ...
                <div class="widget-content padding">
                    <form class="form-horizontal" role="form" action="{{asset('course')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="no_of_seat" value="{{old('no_of_seat')}}" class="form-control" placeholder="No. of Seats">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <img src="" alt="" class="img-thumbnail" id="course-image" style="width: 157px !important;height: 100px !important;border: 1px solid #7a868f;margin-top: 12px;"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="course_duration" value="{{old('course_duration')}}" class="form-control" placeholder="Course Duration">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="course_category" class="form-control">
                                                @foreach($types as $type)
                                                    <option value="{{$type->name}}" {{old('course_category') == $type->name ? 'selected' : ''}}>{{$type->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
