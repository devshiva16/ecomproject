...
@section('BodyContent')
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="{{asset('/answer')}}">answer</a></li><li class="active">Add Answer</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
            ...
            <div class="widget">
                <div class="widget-header transparent">
                    ...
                    <h2><strong>Add</strong> New Answer</h2>
                ...
                <div class="widget-content padding">
                    <form class="form-horizontal" role="form" action="{{asset('answer')}}" method="post">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="ans_title" value="{{old('ans_title')}}" class="form-control" placeholder="Answer Title for Reference">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select name="question" class="form-control">
                                                ...
                                                @foreach($questions as $type)
                                                    <option value="{{$type->id}}" {{old('question', $qid) == $type->id ? 'selected' : ''}}>{{$type->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select name="qtype" class="form-control">
                                                ...
                                                <option value="Right" {{old('qtype') == 'Right' ? 'selected' : ''}}>Right</option>
                                                <option value="Wrong" {{old('qtype') == 'Wrong' ? 'selected' : ''}}>Wrong</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
