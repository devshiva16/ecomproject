...
@section('BodyContent')
    ...
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li class="active">Answer List</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
                ...
                <div class="col-md-12">
                    <div class="widget">
                        <div class="widget-header transparent">
                            <h2><strong>All</strong> Answers</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="toolbar-btn-action">
                                            ...
                                            <form action="{{asset('answer/create')}}" method="post">
                                                {{csrf_field()}}
                                                <a class="btn btn-success" href="{{asset('/answer/create')}}"><i class="fa fa-plus-circle"></i> Add New Answer</a>
                                            </form>
                                ...
                                <table id="datatables-1" data-sortable class="table table-hover table-striped">
                                    ...
                                    @foreach($answers as $item)
                                        <tr>
                                            ...
                                            <td>{{ getQuestionTitle($item->question_id) }}</td>
                                            <td style="text-align: center !important;">
                                                <div class="btn-group btn-group-xs">
                                                    <form method="post" action="{{asset('answer/'.$item->id)}}">
                                                        {{csrf_field()}}
                                                        <a data-toggle="tooltip" href="{{ asset('/answer/'.$item->id.'/edit') }}" title="Edit" class="btn btn-default"><i class="fa fa-edit" style="color: green !important;"></i></a>
                                                        {{method_field('DELETE')}}
