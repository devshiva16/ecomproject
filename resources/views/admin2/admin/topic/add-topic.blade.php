...
@section('BodyContent')
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="{{asset('/topic')}}">Topic</a></li><li class="active">Add Topic</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
            ...
            <div class="widget">
                <div class="widget-header transparent">
                    <h2><strong>Add</strong> New Topic</h2>
                ...
                <div class="widget-content padding">
                    <form class="form-horizontal" role="form" action="{{asset('topic')}}" method="post">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="topic_name" value="{{old('topic_name')}}" class="form-control" placeholder="Topic Name">
