...
@section('BodyContent')
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li class="active">Category List</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
                        ...
                        <div class="widget-header transparent">
                            ...
                            <div class="additional-btn">
                                <li class="nk-block-tools-opt">
                                    ...
                                    <a href="{{ asset('/category/create')}}" data-target="addProduct" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Add Product</span></a>
                                </li>
                                ...
                                <table id="datatables-1" data-sortable class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center !important;">sfdsf</td>
                                            <td style="text-align: center !important;"><strong>fsdgs</strong></td>
