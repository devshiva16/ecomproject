...
@section('BodyContent')
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="{{asset('/module')}}">Module</a></li><li class="active">Add Module</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
            ...
            <div class="widget">
                <div class="widget-header transparent">
                    <h2><strong>Add</strong> New Module</h2>
                ...
                <div class="widget-content padding">
                    <form class="form-horizontal" role="form" action="{{asset('module')}}" method="post">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="module_name" value="{{old('module_name')}}" class="form-control" placeholder="Module Name">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label for="r1" class="col-sm-6">Test Module <input type="radio" id="r1" value="1" name="module_type" class="radio-inline" checked></label>
                                        <label for="r2" class="col-sm-6">Genera Module <input type="radio" id="r2" value="2" name="module_type" class="radio-inline"></label>
                                    ...
                                    <div class="col-sm-8">
                                        <select id="select-course" name="course" class="form-control">
                                            ...
                                            @foreach($courses as $type)
                                                <option value="{{$type->id}}" {{old('course') == $type->id ? 'selected' : ''}}>{{$type->name}}</option>
                                            @endforeach
                                        </select>
