...
@section('BodyContent')
    <div class="content-page">
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li><li><a href="{{asset('/test')}}">Test</a></li><li class="active">Edit Test</li></ol>
        <!-- ============================================================== -->
        <!-- Start Content here -->
        <!-- ============================================================== -->
        <div class="content">
            ...
            <div class="widget">
                ...
                <div class="widget-content padding">
                    <form class="form-horizontal" role="form" action="{{asset('test/'.$items->id)}}" method="post">
                        {{csrf_field()}}
                        {{ method_field('PATCH') }}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="test_name" value="{{old('test_name',$items->name)}}" class="form-control" placeholder="Test Name">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="course" class="form-control">
                                                ...
                                                @foreach($courses as $type)
                                                    <option value="{{$type->id}}" {{old('course', $items->course) == $type->id ? 'selected' : ''}}>{{$type->name}}</option>
                                                @endforeach
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="test_date" value="{{old('test_date', date('d-m-Y',strtotime($items->test_date)))}}" class="form-control datepicker-input" placeholder="Test Date" readonly=>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="start_time" value="{{old('start_time', $items->begin_time)}}" type="text" class="form-control timepicker-input" placeholder="Start Time" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="total_question" value="{{old('total_question', $items->no_of_questions)}}" class="form-control" placeholder="Total no of Question">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="correct_marks" value="{{old('correct_marks', $items->correct_ans_marks)}}" class="form-control" placeholder="Correct Ans Marks">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="subject" class="form-control">
                                                ...
                                                @foreach($subjects as $type)
                                                    <option value="{{$type->name}}" {{old('subject', $items->subject) == $type->name ? 'selected' : ''}}>{{$type->name}}</option>
                                                @endforeach
                                                <option value="N/A" {{old('subject', $items->subject) == 'N/A' ? 'selected' : ''}} style="color: red !important;">Not Applicable</option>
                                            </select>
                                        </div>
                                    </div>
                                    -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" name="test_duration" value="{{old('test_duration', $items->duration)}}" class="form-control" placeholder="Test Duration">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="end_time" value="{{old('end_time', $items->end_time)}}" class="form-control timepicker-input" placeholder="End Time" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="total_option" value="{{old('total_option', $items->no_of_options)}}" class="form-control" placeholder="NO of Options as Answer">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="wrong_marks" value="{{old('wrong_marks', floatval($items->wrong_ans_marks))}}" class="form-control" placeholder="Wrong Ans Marks">
